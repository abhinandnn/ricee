...
function Header() {
  ...
  return (
    ...
    <div className='bg-white backdrop-blur-[10px] bg-opacity-20 text-[1.25rem] text-white px-4 h-[4.5rem] flex items-center sm:justify-end justify-center relative'>
