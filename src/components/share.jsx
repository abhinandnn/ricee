...
const Share = () => {
 ...
 <img src="handss.png " className=" absolute top-[50%] translate-y-[-50%] right-0   md1:w-[63.3vw] mob:right-[-5vw] mob:w-[217px]" />
      <div className=" w-[52.08vw] flex flex-col gap-[4.2vh] md:w-[66vw]">
        ...
        <button className="z-10 text-[#FFF] transition-hover duration-300 hover:bg-white hover:text-mar border border-mar w-[205px] h-[64px] mob1:w-[165px] mob1:h-[56px] rounded-[12px] bg-[#762023] flex justify-center items-center gap-[12px]">
