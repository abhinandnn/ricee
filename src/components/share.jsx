...
const Share = () => {
  return (
    <div className="relative w-[100vw] h-[51.2vh] border-t-[1px] border-b-[1px] border-solid border-[#744150] bg-[#FFE6CE] pl-[7.43vw] pt-[10.2vh] md:pt-[5.89vh] md:pl-[4.44vw] md:h-[45.02vh] overflow-hidden " >
      ...
      <div className=" w-[52.08vw] flex flex-col gap-[4.2vh] md:w-[68.7vw]">
        <div className="z-10 font-gd text-[3rem] not-italic font-[400] leading-[61.44px] text-[#0F0D0A] mob1:text-[2rem] mob1:leading-[40.96px] ">Connect now with our experts for business enquiries</div>
