...
<span className='invisible -z-10 group-hover:z-0 opacity-0 group-hover:opacity-100 group-hover:visible'>Carbs: 92.90 gm</span>
<span className='invisible -z-10 group-hover:z-0 opacity-0 group-hover:opacity-100 group-hover:visible'>Iron: 38.20 mg</span>
<span className='invisible -z-10 group-hover:z-0 opacity-0 group-hover:opacity-100 group-hover:visible'>Zinc: 3.70 mg</span>
