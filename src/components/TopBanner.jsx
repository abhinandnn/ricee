...
function TopBanner() {
  return (
    <div className="relative h-auto pb-[4rem] bg-cover bg-center" style={{backgroundImage: `url(${background.src})`  }}>
      ...
      <button className={`w-[13.875rem] h-[4rem] mob:absolute bottom-[-7%] sm:w-[10rem] sm:h-[3.6rem] bg-mar rounded-[0.75rem] mob:ml-[1rem] text-[1rem] md:mx-8 md:mt-[3rem] text-white lg:mx-[5rem] mx-[6.5rem] mt-[5rem]`}>Order now</button>
    </div>
  )
}
